...
from config import DATA_DIR, DOWNLOAD_GXB_DIR, MAX_PAGES_GXB
...
async def run_gxb_spider():
    ...
    # 读取Excel文档，判断驱虫条件
    excel_path = os.path.join(DATA_DIR, "工信部.xlsx")
            ...
            for page_num in range(1, MAX_PAGES_GXB + 1):
                ...
                for i, li in enumerate(lis):
                    ...
                    try:
                        ...
                        # # 发布文号
                        # fbwh = await gxb_fbwh(detail_page)
